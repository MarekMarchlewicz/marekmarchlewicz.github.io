...
var ContentEvents = new function()
{
	...
	{   if(exit){
            UniwebviewManager.StopMinigameAudio("ContentEvents.backToMainMenu");
        }
        else{
            if(fromDialog){
    ...
    this.StopMinigameAudio=function(){
        UniwebviewManager.StopMinigameAudio("ContentEvents.ChangeMode");
    }
    this.backToMainMenu=function(){
        UniwebviewManager.BackToMainMenu();
    }
    this.ChangeMode=function(){
        UniwebviewManager.EndInteraction("ContentEvents.EndInteraction");
    }
...
function stopSoundMedia(callback){
    UniwebviewManager.StopMinigameAudio(callback);
}

function playSoundNow(file,callback){
    UniwebviewManager.PlayMinigameAudio(file,callback)
}

var Inventory = new function()
{
    ...
    this.traverseThroughInventoryArray = function(){
        if(Inventory.ar.length>1)Inventory.logInventoryObj(Inventory.ar[0],"Inventory.traverseThroughInventoryArray");
        else Inventory.logInventoryObj(Inventory.ar[0],Inventory.callback);
    }
